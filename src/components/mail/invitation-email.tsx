...
export default function InvitationEmail({ role, inviteLink }: InviteProps) {
  return (
    <EmailLayout>
      <Preview>You have been invited to join the Rammy's Radiance team.</Preview>
      ...
      <Text className="text-[15px] leading-[26px] text-[#4B5563] mb-6">
        You have been invited to join the Rammy's Radiance administrative team as an <strong>{role}</strong>. 
      </Text>
