        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="md:col-span-4 flex flex-col items-start">
            ...
            <p className="text-[13px] text-text-muted leading-relaxed max-w-sm mb-8">
              Luxury cosmetics curated for your unique beauty. Experience a new
              era of effortless confidence with our clinically proven,
          ...
          <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8 md:pl-10">
            ...
            <div className="space-y-6">
              <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-text-main">
                Shop
              </h3>
        ...
        <div className="pt-8 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            <a
              ...
              className="flex items-center gap-2 text-[12px] text-text-muted hover:text-black transition-colors"
            >
