...
const testimonials = [
  {
    ...
    rating: 5,
    avatar: "/imgs/profiles/p-2.jpg", 
  },
  {
    id: 2,
    name: "Michelin Appiah",
    role: "Beauty Lover",
    ...
    rating: 5,
    avatar: "/imgs/profiles/p-4.jpg",
  },
  {
    id: 3,
    name: "Prudence Mensah",
              ...
              {testimonials.map((testimonial) => (
                <CarouselItem key={testimonial.id} className="pl-4 md:pl-8 sm:basis-1/2 lg:basis-1/3">
                  <div className="flex flex-col text-center items-center group h-full">
                    ...
                    {/* Quote */}
                    <p className="text-[15px] text-text-muted leading-relaxed mb-8  px-2">
                      "{testimonial.quote}"
                    </p>
