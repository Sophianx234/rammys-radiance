          ...
          return (
            <button
              ...
              onClick={() => {
                setActiveTab(key);
                router.push(
                  navItems.find((item) => item.key === key)?.path || "/",
                );
              }}
      ...
      <div className="border-t border-border/40 p-4 mt-auto space-y-1">
        ...
        >
          <Settings
            size={18}
            strokeWidth={1.5}
            className="flex-shrink-0 text-text-muted group-hover:text-[#222222] transition-colors"
          />
          {!collapsed && (
            <span className="text-[11px] uppercase tracking-wider font-bold whitespace-nowrap">
              Settings
        ...
        >
          <LogOut
            size={18}
            strokeWidth={1.5}
            className="flex-shrink-0 text-red-600 group-hover:text-red-700 transition-colors"
          />
          {!collapsed && (
            <span className="text-[11px] uppercase tracking-wider font-bold whitespace-nowrap">
