      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 md:py-24 flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="lg:w-64 shrink-0">
          <div className="sticky top-32 flex flex-col gap-6">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#5B7763] mb-2">
              Support Menu
            </h3>
        ...
        <div className="flex-1 max-w-3xl flex flex-col gap-24">
          ...
          <section id="contact" className="scroll-mt-32">
            <h2 className="text-2xl font-bold uppercase tracking-wide text-[#222222] mb-8 border-b border-border/40 pb-4">
              Customer Service
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-8 border border-border/40 text-center flex flex-col items-center">
                <Mail
                  className="w-6 h-6 text-[#5B7763] mb-4"
                  strokeWidth={1.5}
                />
                <h4 className="text-[13px] font-bold uppercase tracking-widest text-[#222222] mb-2">
                  Email Us
                </h4>
                ...
                <a
                  href="mailto:support@rammysradiance.com"
                  className="text-[#5B7763] font-medium text-[13px] hover:underline"
                >
                  support@rammysradiance.com
                </a>
              </div>
              <div className="bg-white p-8 border border-border/40 text-center flex flex-col items-center">
                <Phone
            ...
            <form
              className="bg-white p-8 border border-border/40 flex flex-col gap-6"
              onSubmit={(e) => e.preventDefault()}
            >
              <h3 className="text-[13px] font-bold uppercase tracking-[0.1em] text-[#222222] mb-2">
                Send a Message
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    type="text"
                    className="border-b border-border/60 pb-2 bg-transparent text-[13px] focus:outline-none focus:border-[#5B7763] transition-colors"
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  rows={4}
                  className="border-b border-border/60 pb-2 bg-transparent text-[13px] focus:outline-none focus:border-[#5B7763] transition-colors resize-none"
            ...
            <div className="flex flex-col border-t border-border/40">
              {faqs.map((faq, index) => (
                <div key={index} className="border-b border-border/40">
                  ...
                  >
                    <span className="text-[14px] font-medium text-[#222222] group-hover:text-[#5B7763] transition-colors">
                      {faq.q}
                    </span>
                    <ChevronDown
                      className={`w-4 h-4 text-text-muted transition-transform duration-300 ${openFaq === index ? "rotate-180" : ""}`}
                    />
                  </button>
                  <motion.div
                  ...
                  >
                    <p className="text-[14px] leading-relaxed text-text-muted pb-6">
                      {faq.a}
                    </p>
                  </motion.div>
                </div>
          ...
          <section id="shipping" className="scroll-mt-32">
            ...
            <div className="prose prose-sm max-w-none prose-headings:font-bold prose-headings:uppercase prose-headings:tracking-widest prose-headings:text-[13px] prose-p:text-[14px] prose-p:leading-relaxed prose-p:text-text-muted mb-12">
              ...
              <p>
                We pride ourselves on delivering your luxury essentials in
                pristine condition. All orders are processed during the week and
                are dispatched exclusively on <strong>Fridays</strong>. This
                allows us to maintain strict quality control and batch tracking.
              </p>
              <p>
                You will receive a shipping confirmation email containing your
                tracking information on Thursday evening. Standard delivery
                takes 2-5 business days from the dispatch date, depending on
                your location.
              </p>
              ...
              <p>
                ...
                for any reason you are not, we accept returns on unused,
                unopened products in their original packaging within 14 days of
                delivery.
              </p>
              <p>
                To initiate a return, please contact our Customer Service team
                via the form above with your order number. Please note that
                return shipping costs are the responsibility of the customer
                unless the item received was incorrect or defective.
              </p>
              <p>
                For health and hygiene reasons, we strictly cannot accept
                returns or exchanges on opened skincare or cosmetic products.
                Refunds will be processed to the original payment method within
                5-7 business days after we receive and inspect the returned
                items.
              </p>
            </div>
          </section>
