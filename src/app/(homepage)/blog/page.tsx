...
import {
  AnimatedHeader,
  AnimatedFeaturedArticle,
  AnimatedArticleGridItem,
...
const articles = [
  {
    ...
    excerpt:
      "Discover the step-by-step morning routine our founder uses to maintain flawless, luminous skin throughout the day.",
  ...
  },
  {
    ...
    excerpt:
      "Cold weather demands a shift in your skincare approach. Learn which ingredients to prioritize when the temperature drops.",
    category: "Skincare Tips",
    categorySlug: "skincare-tips",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Why this powerhouse vitamin B3 derivative is the secret weapon in our newest serum collection.",
    category: "Brand News",
  ...
  },
  {
    ...
    excerpt:
      "A 5-minute tutorial on enhancing your natural features using our lightweight tinted moisturizer and cream blush.",
  ...
  },
  {
    ...
    excerpt:
      "We are transitioning all of our glass packaging to 100% recycled materials. Read about our commitment to the planet.",
    category: "Brand News",
    categorySlug: "brand-news",
    image:
...
export const metadata: Metadata = {
  ...
  description:
    "Read the latest skincare tips, makeup tutorials, and brand news from Rammy's Radiance.",
  alternates: {
...
export default async function BlogPage(props: {
  ...
  const currentTopic =
    typeof searchParams.topic === "string" ? searchParams.topic : "all";
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16 border-b border-border/40 pb-8">
          {topics.map((topic) => (
            <Link
              key={topic.slug}
              href={
                topic.slug === "all" ? "/blog" : `/blog?topic=${topic.slug}`
              }
        ...
        {/* Featured Article */}
        {featuredArticle && (
          <AnimatedFeaturedArticle article={featuredArticle} />
        )}
