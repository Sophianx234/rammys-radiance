        ...
        <div className="flex-1 max-w-3xl flex flex-col gap-24">
          ...
          <section id="wholesale" className="scroll-mt-32">
            <div className="flex items-center gap-4 mb-8 border-b border-border/40 pb-4">
              ...
              <h2 className="text-2xl font-bold uppercase tracking-wide text-[#222222]">
                Wholesale Partners
              </h2>
            </div>
            ...
            <div className="prose prose-sm max-w-none prose-p:text-[14px] prose-p:leading-relaxed prose-p:text-text-muted mb-8">
              <p>
                We are actively seeking strategic retail partnerships with
                boutiques, spas, and luxury department stores that align with
                our brand ethos. As a wholesale partner, you will receive
                dedicated support, marketing materials, and exclusive previews
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  placeholder="Tell us briefly about your business and why you'd be a good fit."
                ></textarea>
              </div>
          ...
          <section id="press" className="scroll-mt-32">
            ...
            <div className="prose prose-sm max-w-none prose-p:text-[14px] prose-p:leading-relaxed prose-p:text-text-muted mb-8">
              <p>
                For all press inquiries, high-resolution image requests, product
                samples for editorial review, or interview requests with our
                founders, please contact our PR team directly.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-border/40 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-[13px] text-text-muted">
                  Please email us directly for all media requests.
                </p>
              </div>
              <a
                href="mailto:press@rammysradiance.com"
                className="shrink-0 flex items-center gap-2 bg-[#5B7763] text-white text-[11px] font-bold uppercase tracking-widest py-3 px-6 hover:bg-[#222222] transition-colors"
              >
          ...
          <section id="careers" className="scroll-mt-32">
            ...
            <div className="prose prose-sm max-w-none prose-p:text-[14px] prose-p:leading-relaxed prose-p:text-text-muted mb-8">
              <p>
                Join a dynamic team passionate about redefining beauty and
                wellness. At Rammy's Radiance, we foster a culture of
                creativity, inclusivity, and relentless pursuit of quality.
                While we may not always have open positions, we are always eager
                to connect with talented individuals.
              </p>
            </div>
            ...
            <div className="border border-border/40 bg-white">
              ...
              <div className="p-8 bg-surface/50 text-center flex flex-col items-center">
                ...
                <p className="text-[12px] text-text-muted mb-6 max-w-sm">
                  We are always looking for exceptional talent. Send your resume
                  and cover letter, and we'll keep it on file.
                </p>
                <a
                  href="mailto:careers@rammysradiance.com"
                  className="text-[11px] font-bold uppercase tracking-widest text-[#5B7763] hover:text-[#222222] transition-colors"
                >
