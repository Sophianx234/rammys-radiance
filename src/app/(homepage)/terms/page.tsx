...
export const metadata: Metadata = {
  ...
  description:
    "Read the terms and conditions that govern your use of the Rammy's Radiance website.",
};
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 py-16 md:py-24">
        ...
        >
          <p>
            Welcome to <strong>Rammy's Radiance</strong>. These terms and
            conditions outline the rules and regulations for the use of our
            website and the purchase of our products.
          </p>
          <p>
            By accessing this website and purchasing our products, we assume you
            accept these terms and conditions. Do not continue to use Rammy's
            Radiance Radiance if you do not agree to take all of the terms and
            conditions stated on this page.
          </p>

          <h2>1. Introduction and General Terms</h2>
          <p>
            These terms of service govern your use of our website. By
            registering an account, placing an order, or browsing our site, you
            engage in our "Service" and agree to be bound by the following terms
            and conditions ("Terms of Service", "Terms"). These Terms apply to
          ...
          <p>
            ...
            colors and images of our products that appear on the store. However,
          ...
          <ul>
            <li>
              <strong>Order Acceptance:</strong> The receipt of an order number
              or an email order confirmation does not constitute the acceptance
              of an order or a confirmation of an offer to sell. We reserve the
              right, without prior notification, to limit the order quantity on
              any item and/or to refuse service to any customer.
            </li>
            <li>
              <strong>Delivery Schedule:</strong> Please note that Rammy's
              Radiance Radiance dispatches all orders exclusively on{" "}
              <strong>Fridays</strong> to maintain strict quality control and
              batch freshness. By placing an order, you agree to this
              fulfillment schedule.
            </li>
            <li>
              <strong>Shipping Restrictions:</strong> We are not responsible for
              delays caused by customs, natural occurrences, or transit strikes.
              Once a package is handed over to the logistics provider, the
          ...
          <p>
            Due to the nature of our luxury skincare and cosmetic products, we
            adhere to a strict hygiene policy. We accept returns within 14 days
            of receipt only if the products are completely unused, unopened, and
            the tamper-evident seals are fully intact.
          </p>
          <p>
            If a product arrives damaged or defective, you must contact our
            Customer Service team within 48 hours of delivery with photographic
            evidence to arrange an exchange.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            Unless otherwise stated, Rammy's Radiance and/or its licensors own
            ...
            from Rammy's Radiance for your own personal use subjected to
          ...
          <ul>
            ...
            <li>
              Reproduce, duplicate or copy material from Rammy's Radiance
              Radiance
            </li>
          ...
          <p>
            In no case shall Rammy's Radiance, our directors, officers,
          ...
          <p>
            ...
            accordance with the laws of the jurisdiction in which Rammy's
            Radiance Radiance is headquartered, without regard to its conflict
            of law provisions.
          </p>
