...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Rammy's Radiance collects, uses, and protects your personal data.",
};
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 py-16 md:py-24">
        ...
        >
          <p>
            At <strong>Rammy's Radiance</strong>, we respect your privacy and
          ...
          <p>
            Rammy's Radiance is the controller and responsible for your personal
            ...
            policy. If you have any questions, including any requests to
            exercise your legal rights, please contact us at{" "}
            <strong>privacy@rammysradiance.com</strong>.
          </p>
          ...
          <ul>
            <li>
              ...
              username or similar identifier, title, and date of birth.
            </li>
            <li>
            ...
            <li>
              ...
              (processed securely via our payment gateways, not stored directly
              on our servers).
            </li>
            <li>
            ...
            <li>
              ...
              setting and location, and other technology on the devices you use
          ...
          <ul>
            <li>
              ...
              includes personal data you provide when you create an account,
              purchase our products, or subscribe to our newsletter.
            </li>
            <li>
          ...
          <p>
            ...
            contact our Data Privacy Manager via the Contact page.
          </p>
        </article>
      </div>
    </div>
