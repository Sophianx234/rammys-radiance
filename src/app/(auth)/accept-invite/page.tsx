    ...
    <div className="grid min-h-svh lg:grid-cols-2 bg-[#FAFAFA]">
      <div className="flex flex-col gap-4 p-6 md:p-10">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-sm   ">
            ...
            <Suspense fallback={<div className="text-center text-sm text-zinc-500"><Loader2 className="animate-spin" /></div>}>
              <AcceptInviteForm />
            </Suspense>
          </div>
        </div>
      ...
      <div className="relative hidden bg-zinc-900 lg:block border-l border-zinc-200/80">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          ...
          <p className="text-zinc-300 font-medium">Join the management portal to securely oversee hair extensions, orders, and customer experiences.</p>
        </div>
      </div>
    </div>
  );
